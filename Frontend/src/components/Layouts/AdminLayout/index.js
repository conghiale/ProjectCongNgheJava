...
const items = [
    getItem('Quản lý sách', '1', <PieChartOutlined />, [getItem('Danh sách sách', '11'), getItem('Thêm sách', '12')]),
    getItem('Quản lý người dùng', '2', <DesktopOutlined />),
    getItem('Quản lý danh mục', '3', <DesktopOutlined />),
    ...
    return (
        ...
        >
            <Sider collapsible collapsed={collapsed} onCollapse={(value) => setCollapsed(value)}>
                ...
                />
                <Menu onClick={onClick} theme="dark" defaultSelectedKeys={[page]} mode="inline" items={items} />
            </Sider>
